...
import { pacientes as pacientesAPI } from "../../service/api";
  ...
  return (
    <div className="p-6">
      ...
      <div className="flex flex-col gap-3">
        {carregando && (
          <div className="text-center py-12 text-gray-400">Carregando pacientes...</div>
        )}
        {!carregando && pacientesFiltrados.map((p) => (
          <div
            key={p.id}
