...
import { dadosDashboard } from "../../data/dashboard";
...
export default function Dashboard() {
  ...
  const { atendimentosHoje, pacientesAtivos, cancelamentosHoje, planosVencendo, taxaOcupacao, slotsTotal, slotsPreenchidos, alertas } = dadosDashboard;
  ...
  return (
    <div className="p-6 flex flex-col gap-5">
      ...
      <div className="grid grid-cols-4 gap-4">
        ...
        <Stats
          label="Cancelamentos"
          valor={String(cancelamentosHoje)}
          descricao="Hoje"
          icon={XCircle}
            ...
            <div className="flex flex-col gap-2.5">
              {alertas.map((a, i) => (
                <div key={i} className="flex items-start gap-2.5 text-sm text-gray-600">
                  <div className={`w-2 h-2 rounded-full flex-shrink-0 mt-1.5 ${a.cor}`} />
