...
export default function Login() {
  ...
  function handleLogin(e) {
    ...
    localStorage.setItem('usuario', JSON.stringify({ nome: 'Enzo Ribeiro', cargo: 'Fisioterapeuta' }))
    navigate('/home')
  }
        ...
        <div className="bg-white rounded-3xl shadow-2xl overflow-hidden">
          ...
          <div className="px-8 py-7">
            ...
            <form onSubmit={handleLogin} className="flex flex-col gap-4">
              ...
              <button
                type="submit"
                className="flex items-center justify-center gap-2 w-full py-3 rounded-xl bg-gradient-to-r from-[#005073] to-[#0099cc] text-white font-semibold hover:opacity-90 hover:scale-[1.02] hover:shadow-lg transition-all duration-200 mt-1"
              >
